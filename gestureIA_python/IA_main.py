...
if __name__ == "__main__":
	...
	# siamese分类（基于原数据）
	siamese_data_classifier.siamese_data_based_classifier(feature[:,0:2],target,targetnum)
	# siamese_classifier.siamese_ori_final_class(feature[:,0:2],target,targetnum)
