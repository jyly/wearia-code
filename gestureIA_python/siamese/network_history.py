...
#注意力模块
def attentation_module(inputs):
    inshape=int(inputs.shape[2])
...
def resnet1d_network(input_shape):
    inputs = Input(shape=input_shape, name='input')

    x = Reshape((int(input_shape[0]),int(input_shape[1]),1))(inputs)

    x1 = Conv2D(16, (1, 3),padding='same')(x)
    x1 = BatchNormalization(axis=2)(x1)
    x1 = Activation('relu')(x1)


    x1 = Conv2D(16, (1, 3),padding='same')(x1)
    x1 = BatchNormalization(axis=2)(x1)
    x1 = Activation('relu')(x1)
    ...
    y =  Conv2D(16, (1, 3),padding='same')(x)
    ...
    x1 = Conv2D(32, (1, 3),padding='same')(x)
    x1 = BatchNormalization(axis=2)(x1)
    x1 = Activation('relu')(x1)

    x1 = Conv2D(32, (1, 3),padding='same')(x1)
    x1 = BatchNormalization(axis=2)(x1)
    x1 = Activation('relu')(x1)
    ...
    y =  Conv2D(32, (1, 3),padding='same')(x)
    y = BatchNormalization(axis=2)(y)
    x1 = Add()([y,x1])
...
#     x2 = MaxPooling2D(pool_size=(1, 2))(x1) 
#     x2 = Conv2D(8, (1, 3), activation='relu',padding='same')(x2)
#     x2 = Dropout(0.1)(x2)

#     x3 = MaxPooling2D(pool_size=(1, 2))(x2)
#     x3 = Conv2D(8, (1, 3), activation='relu',padding='same')(x3)
#     x3 = Dropout(0.1)(x3)
#     # x3 = MaxPooling2D(pool_size=(1, 2))(x3)
...
#     y1=Reshape((a,b))(y1)
#     y1=Permute((2,1))(y1)
#     y1 = CuDNNLSTM(units=32,input_shape=(200,2),return_sequences=True)(y1)
#     y1 = CuDNNLSTM(units=32,input_shape=(200,32))(y1)
#     x = Flatten()(y1)
#     x = Dense(128, activation='relu',name='output')(x)
...
# def pyramid_network_3(input_shape):
#     a=int(input_shape[0])
#     b=int(int(input_shape[1]/2))
#     inputs = Input(shape=input_shape, name='input')
#     x = Reshape((int(input_shape[0]),int(input_shape[1]),1))(inputs)
...
#     y1=Reshape((a,b))(y1)
#     y1=Permute((2,1))(y1)
#     y1 = CuDNNLSTM(units=8,return_sequences=True)(y1)
#     y1 = CuDNNLSTM(units=8)(y1)
#     x = Flatten()(y1)
#     x = Dense(32, activation='relu',name='output')(x)


#     # y1 = Conv2D(1, (6, 1), activation='relu')(y1)
#     # y1 = Flatten()(y1)

#     # y2 = Permute((2,1))(inputs)
#     # y2 = CuDNNLSTM(units=8,return_sequences=True)(y2)
#     # y2 = CuDNNLSTM(units=8)(y2)
